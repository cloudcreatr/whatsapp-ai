...
Inlcude All your response in confirmMessage tool body Maximum 1024 characters.
        ...
        <search>
		1. you have abiitiy to search for subject by calling the search tool which will give you top 10 relevant subjects to query
		2. you can further send the message with options of top subjects you found
